...
const TopNavbar = () => {
  ...
  const notifications = [
    ...
    {
      id: 2,
      message: "Reminder: Take medication",
      time: "1 hour ago",
      read: false,
    },
    {
      id: 3,
      message: "Dr. Johnson approved your request",
      time: "Yesterday",
      read: true,
    },
  ];
            ...
            {showProfile && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border z-50">
                  ...
                  <div className="p-2">
                    <Link
                        to="/"
                        className="w-full text-left px-3 py-2 text-sm rounded-md hover:bg-gray-100 block"
                    >
                      Profile
                    </Link>
                    <Link
