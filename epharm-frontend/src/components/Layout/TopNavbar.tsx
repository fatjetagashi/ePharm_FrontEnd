...
const TopNavbar = () => {
  ...
  return (
    <header className="bg-white border-b px-4 py-3 lg:py-4 flex items-center justify-between z-20">
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        ...
        <div className="relative">
          ...
          >
            <Avatar className="w-8 h-8 bg-health-primary text-white rounded-full">
              <AvatarFallback>
          ...
          {showProfile && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border z-50">
              <div className="p-3 border-b">
                ...
                <p className="text-sm text-gray-500">{user.patientId}</p>
                <p className="text-sm text-gray-500">{user.role}</p>
              </div>
              <div className="p-2">
                <Link to="/" className="w-full text-left px-3 py-2 text-sm rounded-md hover:bg-gray-100 block">
                  Profile
                </Link>
                <Link to="/settings" className="w-full text-left px-3 py-2 text-sm rounded-md hover:bg-gray-100 block">
                  Settings
                </Link>
