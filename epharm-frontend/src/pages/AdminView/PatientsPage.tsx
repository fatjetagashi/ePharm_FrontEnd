...
import { RadioGroup, RadioGroupItem } from '../../../../../../Downloads/pharm-nexus-connect-37-main (1)/pharm-nexus-connect-37-main/src/components/ui/radio-group';
...
const PatientsPage = () => {
  ...
  const [patients, setPatients] = useState<Patient[]>([
    { id: '1', name: 'Alice Johnson', age: 45, gender: 'Female', conditions: ['Hypertension'], lastVisit: '2025-04-05', status: 'active', prescriptions: 2, email: 'alice@example.com', phone: '(555) 123-4567', dateOfBirth: '1980-06-15', address: '123 Main St, Anytown' },
    { id: '2', name: 'Robert Smith', age: 32, gender: 'Male', conditions: ['Diabetes Type 2'], lastVisit: '2025-04-02', status: 'active', prescriptions: 1, email: 'robert@example.com', phone: '(555) 234-5678', dateOfBirth: '1993-03-22', address: '456 Oak Ave, Somewhere' },
    { id: '3', name: 'Emma Davis', age: 28, gender: 'Female', conditions: ['Asthma'], lastVisit: '2025-03-30', status: 'active', prescriptions: 3, email: 'emma@example.com', phone: '(555) 345-6789', dateOfBirth: '1997-11-08', address: '789 Pine St, Nowhere' },
    { id: '4', name: 'James Wilson', age: 56, gender: 'Male', conditions: ['Arthritis', 'Hypertension'], lastVisit: '2025-03-25', status: 'inactive', prescriptions: 0, email: 'james@example.com', phone: '(555) 456-7890', dateOfBirth: '1969-01-30', address: '101 Elm St, Anywhere' },
    { id: '5', name: 'Olivia Brown', age: 41, gender: 'Female', conditions: ['Migraine'], lastVisit: '2025-03-20', status: 'active', prescriptions: 1, email: 'olivia@example.com', phone: '(555) 567-8901', dateOfBirth: '1984-09-12', address: '202 Maple Dr, Everywhere' },
    { id: '6', name: 'Michael Lee', age: 37, gender: 'Male', conditions: ['Anxiety'], lastVisit: '2025-03-18', status: 'active', prescriptions: 2, email: 'michael@example.com', phone: '(555) 678-9012', dateOfBirth: '1988-07-25', address: '303 Cedar Ln, Someplace' },
    { id: '7', name: 'Sophia Garcia', age: 62, gender: 'Female', conditions: ['Osteoporosis', 'Hypothyroidism'], lastVisit: '2025-03-15', status: 'active', prescriptions: 4, email: 'sophia@example.com', phone: '(555) 789-0123', dateOfBirth: '1963-04-18', address: '404 Birch Rd, Otherplace' },
    { id: '8', name: 'David Taylor', age: 29, gender: 'Male', conditions: ['Depression'], lastVisit: '2025-03-12', status: 'inactive', prescriptions: 0, email: 'david@example.com', phone: '(555) 890-1234', dateOfBirth: '1996-12-03', address: '505 Willow Way, Elsewhere' },
  ]);
  ...
  const handleAddPatient = () => {
    ...
    const newPatient: Patient = {
      ...
      conditions: formData.conditions.split(',').map(condition => condition.trim()),
  ...
  const handleEditPatient = () => {
    ...
    // Calculate age from date of birth
    const dob = new Date(formData.dateOfBirth || selectedPatient.dateOfBirth || '');
    const today = new Date();
    let age = today.getFullYear() - dob.getFullYear();
    const monthDiff = today.getMonth() - dob.getMonth();
    if (monthDiff < 0 || (monthDiff === 0 && today.getDate() < dob.getDate())) {
  ...
  const filteredPatients = patients.filter(patient => {
    ...
    const matchesAgeGroup = ageGroupFilter === 'all' ? true :
                  ...
                  <TableRow key={patient.id}>
                    <TableCell className="font-medium">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p>{patient.name}</p>
                          <p className="text-sm text-muted-foreground">{getAgeGroup(patient.age)}</p>
                        </div>
                      </div>
                    </TableCell>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="conditions" name="conditions" placeholder="Hypertension, Diabetes, etc." value={formData.conditions} onChange={handleInputChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" name="email" type="email" placeholder="patient@example.com" value={formData.email} onChange={handleInputChange} />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2 col-span-2">
                ...
                <Textarea id="address" name="address" placeholder="123 Main St, City, State, ZIP" value={formData.address} onChange={handleInputChange} />
              </div>
            </div>
          </div>
          <DialogFooter>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="edit-conditions" name="conditions" placeholder="Hypertension, Diabetes, etc." value={formData.conditions} onChange={handleInputChange} />
              </div>
              <div className="space-y-2">
