...
export default function DoctorDoctorsPage() {
    ...
    const handleSubmit = async (values: any, { setSubmitting }: any) => {
        try {
            const response = await axiosInstance.post("/register/doctor/basic", values);
    ...
    return (
        <div style={{ maxWidth: 400, margin: "auto", padding: 20, fontFamily: "Arial, sans-serif" }}>
            <h2 style={{ textAlign: "center", marginBottom: 20 }}>Register as Doctor</h2>
                    ...
                    <Form>
                        {["name", "email", "password", "specialty"].map((field) => (
                            <div key={field} style={{ marginBottom: 16 }}>
                                ...
                                />
                                <ErrorMessage name={field} component="div" style={{ color: "red", fontSize: 14 }} />
                            </div>
                        ))}
